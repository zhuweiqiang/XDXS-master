...
public final class GiveLargessRecordDxo {

	public static void dtoToEntity(GiveLargessRecordDto dto, LargessRecord entity) {
	...
	public static void entityToDto(LargessRecord entity, GiveLargessRecordDto dto) {
