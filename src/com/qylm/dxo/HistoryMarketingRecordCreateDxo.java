...
public final class HistoryMarketingRecordCreateDxo {

	public static void dtoToEntity(HistoryMarketingRecordCreateDto dto, MarketingRecord entity) {
	...
	public static void entityToDto(MarketingRecord entity, HistoryMarketingRecordCreateDto dto) {
