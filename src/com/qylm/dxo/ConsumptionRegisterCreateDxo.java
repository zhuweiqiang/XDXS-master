...
public final class ConsumptionRegisterCreateDxo {

	public static void dtoToEntity(ConsumptionRegisterCreateDto dto, ConsumptionRegister entity) {
	...
	public static void entityToDto(ConsumptionRegister entity, ConsumptionRegisterCreateDto dto) {
