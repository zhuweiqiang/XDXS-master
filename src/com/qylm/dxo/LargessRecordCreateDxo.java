...
public final class LargessRecordCreateDxo {

	public static void dtoToEntity(LargessRecordCreateDto dto, LargessRecord entity) {
	...
	public static void entityToDto(LargessRecord entity, LargessRecordCreateDto dto) {
