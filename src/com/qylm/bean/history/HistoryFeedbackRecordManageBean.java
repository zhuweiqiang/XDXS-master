...
import com.qylm.bean.returner.history.HistoryFeedbackRecordManageReturner;
...
@ManagedBean
@RequestScoped
public class HistoryFeedbackRecordManageBean extends BasePagingBean {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 2134061489330694939L;

	/**
	 * LOG
	 */
	private static final Log LOG = LogFactory.getLog(HistoryFeedbackRecordManageBean.class);
	
	/**
	 * 保存事件管理画面需要保存的值
	 */
	private HistoryFeedbackRecordManageDto historyFeedbackRecordManageDto = new HistoryFeedbackRecordManageDto();
	...
	public String getAll() {
		...
		fetchData(0, true);
		return Navigation.HISTORY_FEEDBACK_RECORD_MANAGE;
	}
	...
	public String newFeedbackRecord() {
		...
		return Tool.getBackBean(HistoryFeedbackRecordCreateBean.class).newCreate(new HistoryFeedbackRecordManageReturner(historyFeedbackRecordManageDto, currentPage));
	}
	...
	public String updateFeedbackRecord(FeedbackRecord transferFeedbackRecord) {
		...
		return Tool.getBackBean(HistoryFeedbackRecordCreateBean.class).updateDetail(new HistoryFeedbackRecordManageReturner(historyFeedbackRecordManageDto, currentPage), transferFeedbackRecord);
	}
	...
	public String viewDetail(FeedbackRecord transferFeedbackRecord) {
		...
		return Tool.getBackBean(HistoryFeedbackRecordViewBean.class).viewDetail(transferFeedbackRecord);
	}
	...
	protected void fetchData(int start, boolean needInit) {
		...
		String name = historyFeedbackRecordManageDto.getName();
		Date beginDate = historyFeedbackRecordManageDto.getBeginDate();
		Date endDate = historyFeedbackRecordManageDto.getEndDate();
	...
	/**
	 * get historyFeedbackRecordManageDto
	 * @return the historyFeedbackRecordManageDto
	 */
	public HistoryFeedbackRecordManageDto getHistoryFeedbackRecordManageDto() {
		return historyFeedbackRecordManageDto;
	}

	/**
	 * set historyFeedbackRecordManageDto
	 * @param historyFeedbackRecordManageDto the historyFeedbackRecordManageDto to set
	 */
	public void setHistoryFeedbackRecordManageDto(HistoryFeedbackRecordManageDto historyFeedbackRecordManageDto) {
		this.historyFeedbackRecordManageDto = historyFeedbackRecordManageDto;
	}
