...
package com.qylm.faces.component.savestate;
...
public class SaveState extends UIParameter {
	...
	public static final String COMPONENT_TYPE = "com.qylm.faces.component.SaveState";
	public static final String COMPONENT_FAMILY = "com.qylm.faces.component";
