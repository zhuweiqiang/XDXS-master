 ...
 */
@Entity
@Table(uniqueConstraints = {}, name = "custominfo")
@DiscriminatorValue(CustomInfo.DISCRIMINATOR_CUSTOM_INFO)
public class CustomInfo extends BaseEntity {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -5599773583571625155L;
	
	/**
	 * @DiscriminatorValue
	 */
	public static final String DISCRIMINATOR_CUSTOM_INFO = "customInfo";
	 ...
	 * 查询条件：卡项号
	 */
	public static final String LEAGUER_NUMBER = "leaguerNumber";
	...
	/**
	 * 在美容店接受面部皮肤护理经验,true有反之无
	 */
	private boolean hljy;
	 ...
	 */
	public void setHljy(boolean hljy) {
		this.hljy = hljy;
	}
