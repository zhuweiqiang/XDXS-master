 ...
 * @author smj
 */
public class MealBuyRecordCreateDto implements Serializable {
	
	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -4531137447734806607L;
	...
	/**
	 * @param sumReadyMoney the sumReadyMoney to set
	 */
