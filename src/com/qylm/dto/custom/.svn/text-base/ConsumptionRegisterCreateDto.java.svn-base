 ...
 * @author smj
 */
public class ConsumptionRegisterCreateDto implements Serializable {
	 ...
	 * 付费项目列表
	 */
	private List<ConsumptionRegisterProjectDto> dtoList;
	 ...
	 * @return the dtoList
	 */
	public List<ConsumptionRegisterProjectDto> getDtoList() {
		return dtoList;
	}
	 ...
	 */
	public void setDtoList(List<ConsumptionRegisterProjectDto> dtoList) {
